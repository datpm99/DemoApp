...
class _DropdownMenuPainter extends CustomPainter {
  ...
  ///which is dropdown item's background color
  final Color? color;

  ///which is dropdown whole item list's elevation
  final int? elevation;

  ///which is selected item's index
  final int? selectedIndex;

  ///which is resized animation value
  final Animation<double>? resize;

  ///which is panting value
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              borderRadius: (itemIndex == 0)
                  ...
                  : (itemIndex == route.items!.length - 1)
                      ? BorderRadius.only(
...
class DropdownBelow<T> extends StatefulWidget {
  ...
  /// default value that printed which has no touch to dropdown widgets.
        ...
        child: widget.icon == null
            ...
            : Row(
                ...
                children: <Widget>[
                  ...
                  isOpenDrop
                      ? Icon(Icons.keyboard_arrow_up, color: Color(0xff7B8794))
